...
#. **Étalonnage et précision** :
   ...
   - Pour garantir une gestion optimale, le routeur doit être étalonné en fonction des caractéristiques spécifiques de l’installation électrique (voir :ref:`etalonnage-monophase` ou :ref:`etalonnage-triphase`).
...
- **Gestion multi-phases** :
  ...
  - La configuration triphasée peut gérer les surplus sur plusieurs phases indépendamment.
